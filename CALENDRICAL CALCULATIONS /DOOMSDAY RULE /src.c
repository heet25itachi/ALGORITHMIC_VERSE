...
const char* weekdays[] = {"Noneday", "Oneday", "Twosday", "Treblesday", "Foursday", "Fiveday", "Six-a-day"};
...
int get_doomsday(int year) {
    int c = year / 100;
    int y = year % 100;
    int anchor = (5 * (c % 4) + 2) % 7; // Tuesday = 2
    int a = y / 12;
    int b = y % 12;
    int c_y = b / 4;
...
int main() {
    int tests[][3] = {{18, 9, 1985}, {12, 4, 1861}, {25, 12, 2021}, {7, 8, 1966}};
    for (int i = 0; i < 4; i++) {
